        ...
        <div class="google-sign-in" data-onsuccess="onSignIn">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <ul class="label-grey password-cond hide">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="repasswordInput" placeholder="Password" required>
                    <span class="fa fa-fw fa-eye passToggle" id="togglePassword" aria-hidden="true">
                    </span>
                </div>
                <div class="form-group float-left">
